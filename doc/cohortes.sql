...
CREATE TABLE IF NOT EXISTS Archivo (
  ...
  `pesobyte` BIGINT CHECK (`pesobyte` > 0) NULL ,
  PRIMARY KEY (`id`),
...
CREATE UNIQUE INDEX email ON Contacto (`email1` ASC) VISIBLE;
...
CREATE UNIQUE INDEX index_idexterno ON Materia (`idexterno` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS Horariocurso (
  ...
  `reunionvideoconferenciaId` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS Respuesta (
 ...
 fechaHora TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
 PRIMARY KEY (`id`),
